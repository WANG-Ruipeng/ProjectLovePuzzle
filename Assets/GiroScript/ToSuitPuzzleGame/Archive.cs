...
static public class Archive
{
    ...
    public static CollectibleInformation[] CollectiblesInfo => collectiblesInfo;
    static CollectibleInformation[] collectiblesInfo;
    ...
    static public void Load()
    {
        ...
        collectiblesInfo = new CollectibleInformation[collectibleTypeCount];
        ...
        for (int i = 0; i < collectibleTypeCount; i++)
        {
            ...
            collectiblesInfo[i] = new CollectibleInformation(i, unlocked);
        }
        hasLoad = true;
    }
...
public class CollectibleInformation
{
    ...
    public CollectibleInformation(int id, bool unlocked)
    {
        this.id = id;
